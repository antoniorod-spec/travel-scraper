...
import { extractMetaTitle, extractMetaDescription } from './extractors/meta';
import { extractCountries, extractCities, extractOrigins } from './extractors/geography';
import { extractDaysNights, extractDates } from './extractors/dates';
import { extractImages } from './extractors/images';
import { extractCategory1, normalizeCategory1, extractTagCategories } from './extractors/categories';
import { extractSection, extractHotels, extractPriceFooter, extractPrice } from './extractors/content';
import { extractItineraryDays, extractItineraryTexts } from './extractors/itinerary';
import { buildTitle, buildDateText } from './utils';
